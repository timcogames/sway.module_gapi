...
inline std::basic_ostream<Type, Traits> &operator<<(
  ...
  switch (value) {
    case sway::gapi::VertexSemantic_t::kPosition:
      return stream << "attr_position";
    case sway::gapi::VertexSemantic_t::kColor:
      return stream << "attr_color";
    case sway::gapi::VertexSemantic_t::kTexCoord_0:
      return stream << "attr_texcoord_0";
    case sway::gapi::VertexSemantic_t::kTexCoord_1:
      return stream << "attr_texcoord_1";
    case sway::gapi::VertexSemantic_t::kTexCoord_2:
      return stream << "attr_texcoord_2";
    case sway::gapi::VertexSemantic_t::kTexCoord_3:
      return stream << "attr_texcoord_3";
    case sway::gapi::VertexSemantic_t::kTexCoord_4:
      return stream << "attr_texcoord_4";
    case sway::gapi::VertexSemantic_t::kTexCoord_5:
      return stream << "attr_texcoord_5";
    case sway::gapi::VertexSemantic_t::kTexCoord_6:
      return stream << "attr_texcoord_6";
    case sway::gapi::VertexSemantic_t::kTexCoord_7:
      return stream << "attr_texcoord_7";
    case sway::gapi::VertexSemantic_t::kNormal:
      return stream << "attr_normal";
    case sway::gapi::VertexSemantic_t::kTangent:
      return stream << "attr_tangent";
    case sway::gapi::VertexSemantic_t::kBinormal:
      return stream << "attr_binormal";
    case sway::gapi::VertexSemantic_t::kBlendWeights:
      return stream << "attr_blend_weights";
    case sway::gapi::VertexSemantic_t::kBlendIndices:
