...
DECLARE_PTR_TYPES(Capability)
DECLARE_PTR_TYPES(Shader)
DECLARE_PTR_TYPES(ShaderProgram)
DECLARE_PTR_TYPES(ShaderPreprocessor)
DECLARE_PTR_TYPES(Texture)
DECLARE_PTR_TYPES(TextureSampler)
DECLARE_PTR_TYPES(RenderBuffer)
DECLARE_PTR_TYPES(FrameBuffer)
DECLARE_PTR_TYPES(IdGenerator)
DECLARE_PTR_TYPES(VertexArray)
DECLARE_PTR_TYPES(Buffer)
DECLARE_PTR_TYPES(VertexAttribLayout)
DECLARE_PTR_TYPES(Viewport)
DECLARE_PTR_TYPES(DrawCall)
DECLARE_PTR_TYPES(StateContext)
DECLARE_PTR_TYPES(Uniform)
